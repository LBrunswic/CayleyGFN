...
docker run --rm --cpuset-cpus=1-4 --gpus '"device=0"' -v /home/maxbrain/DATA/TaskForce/logs:/TASK/LOGS/ -v /home/maxbrain/DATA/TaskForce/Results:/TASK/RESULTS/ -v /home/maxbrain/DATA/TaskForce/Models:/TASK/MODELS/ ploptest  python3 launch.py --HP_FOLDER='Hyperparameters/experimental_settings_S10G2W1' --pool_size='32' &> gpu1.log & disown
